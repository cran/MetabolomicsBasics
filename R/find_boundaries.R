...
#' @description \code{find_boundaries} will determine peak boundaries within a BPC or mass trace.
#' @details It is yet another peak finder or, more precisely, it is a function
...
#' @return Numeric vector of length=2 specifying the start and end index of the peak.
#' @examples
